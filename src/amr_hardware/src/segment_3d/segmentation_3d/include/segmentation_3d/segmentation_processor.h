...
public:
    ...
    void publish_debug_pointcloud(const pcl::PointCloud<pcl::PointXYZ>& debug_cloud);
  
    pcl::PointXYZ compute_center_point(const sensor_msgs::msg::PointCloud2& cloud_pc2,
                                          const pcl::PointCloud<pcl::PointXYZ>::ConstPtr& cloud_pcl,
                                          const segmentation_msgs::msg::ObjectSegment& object_segment);
    void push_center_marker(const pcl::PointXYZ& center);
