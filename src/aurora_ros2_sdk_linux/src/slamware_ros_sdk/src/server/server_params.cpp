...
namespace slamware_ros_sdk {
    ...
    void ServerParams::resetToDefault()
    {
        ...
        this->declare_parameter<float>("stereo_camera_info_pub_period", 0.05f);
        this->declare_parameter<float>("point_cloud_pub_period", 0.2f);
        this->declare_parameter<float>("enhanced_imaging_pub_period", 0.1f);
        ...
        this->declare_parameter<std::string>("camera_left_camera_info_topic", "/camera/left/camera_info");
        this->declare_parameter<std::string>("camera_right_camera_info_topic", "/camera/right/camera_info");
        ...
        this->declare_parameter<std::string>("semantic_labels_topic_name", "/slamware_ros_sdk_server_node/semantic_labels");
        ...
        // false: disable ServerStereoCameraInfoWorker (Classic Aurora: getCameraCalibration returns -7; use aurora_sdk_bridge instead)
        this->declare_parameter<bool>("stereo_camera_info_enable", false);
    }
    ...
    void ServerParams::setBy(const std::shared_ptr<rclcpp::Node> nhRos)
    {
        ...
        if (nhRos->has_parameter("stereo_camera_info_pub_period")) {
            nhRos->declare_parameter<float>("stereo_camera_info_pub_period", fVal);
        }
        ...
        if (nhRos->has_parameter("camera_left_camera_info_topic")) {
            nhRos->declare_parameter<std::string>("camera_left_camera_info_topic", strVal);
        }
        if (nhRos->has_parameter("camera_right_camera_info_topic")) {
            nhRos->declare_parameter<std::string>("camera_right_camera_info_topic", strVal);
        }
        ...
        if (nhRos->has_parameter("semantic_labels_topic_name")) {
            nhRos->declare_parameter<std::string>("semantic_labels_topic_name", strVal);
        }
        ...
        if (nhRos->has_parameter("stereo_camera_info_enable")) {
            nhRos->declare_parameter<bool>("stereo_camera_info_enable", bVal);
        }
    }
