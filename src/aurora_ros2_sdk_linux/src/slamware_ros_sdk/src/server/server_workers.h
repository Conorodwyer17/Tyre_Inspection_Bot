...
namespace slamware_ros_sdk {
    ...
    private:
        ...
        rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr pubSemanticLabels_;
    ...
    private:
        void fillCameraInfoFromCalibration(
        ...
        bool calibrationReceived_;
        slamtec_aurora_sdk_camera_calibration_t lastCalib_;
    };
